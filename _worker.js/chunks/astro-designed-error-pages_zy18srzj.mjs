...
import { aq as REDIRECT_STATUS_CODES, A as AstroError, ar as ActionsReturnedInvalidDataError, w as escape, J as DEFAULT_404_COMPONENT } from './astro/server_COQxwrqf.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, CI: true })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { _: process.env._, CI: true })?.PROD) {
